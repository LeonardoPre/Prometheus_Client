...
class ExperimentResults:
    ...
    def __init__(self, exp_dir, load_stats_history=True, remove_outliers=True, sut="", ENERGY_WORKLOADS=["fixed", "shaped"]):
    ...
    def _calc_energy(self, input_, wattages, energy_workloads=True, app_namespace_only=False):
        """
        ...
        if app_namespace_only:
            raw = raw[raw['namespace'] == "teastore"]
